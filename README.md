...
> [!TIP]
> превью проекта размещено после инструкции по развертыванию 
...
1. Настраиваем конфиг-файл для автоматического запуска `.env.` для gunicorn, используя встроенный редактор `nano`:
...
![preview gif](/preview/good_prev.gif)
